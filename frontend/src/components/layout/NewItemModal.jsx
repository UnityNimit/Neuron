        ...
        <form onSubmit={handleSubmit} className="p-6 flex flex-col gap-4 bg-[#141414]">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-slate-400 text-xs font-medium">
              {itemType === 'file' ? 'File Path (e.g. src/utils/helpers.py or solution.js)' : 'Folder Name (e.g. models or src/controllers)'}
            </label>
            <input
              type="text"
              autoFocus
              ...
              placeholder={itemType === 'file' ? 'e.g. main.py or data.json' : 'e.g. utils'}
          ...
          <div className="flex items-center justify-end gap-2 mt-2">
            ...
            <button
              type="submit"
              className="px-5 py-2 text-xs font-semibold bg-blue-600 hover:bg-blue-500 text-white rounded-lg transition-colors shadow-lg"
            >
